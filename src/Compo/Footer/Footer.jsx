...
<footer className="bg-white dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl">
      <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        ...
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                    <NavLink to="/features" className={(({isActive}) => ` hover:underline ${isActive ? "text-red-600" : "text-gray-500"} `)} >Features</NavLink>
                </li>
                <li className="mb-4">
    ...
    <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a to="https://flowbite.com/">Flowbite™</a>. All Rights Reserved.
        </span>
